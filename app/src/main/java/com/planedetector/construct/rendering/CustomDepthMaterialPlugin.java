...
public class CustomDepthMaterialPlugin implements IMaterialPlugin {
    private DepthFragmentShaderFragment mFragmentShader;

    public CustomDepthMaterialPlugin() {
...
//			gl_FragDepth = depth;
            ...
            RFloat max= new RFloat(3.0);

            RFloat depth = new RFloat("depth");
            depth.assign(1.0f);
            depth.assignSubtract(enclose(GL_FRAG_COORD.z().divide(GL_FRAG_COORD.w())).divide(max));
